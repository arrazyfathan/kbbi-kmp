...
fun WordResultDto.toDomain(): WordResultModel = WordResultModel(
    word = word,
...
private fun MeaningDto.toDomain(): MeaningModel = MeaningModel(
    wordClass = wordClass,
    description = description,
)

fun ListWordEntity.toDomain(): ListWordModel = ListWordModel(
    word = word,
...
private fun WordEntity.toDomain(): WordModel = WordModel(
    entry = entry,
    meanings = meanings.map { it.toDomain() },
)

private fun MeaningEntity.toDomain(): MeaningModel = MeaningModel(
    wordClass = wordClass,
    description = description,
)
...
private fun WordModel.toEntity(): WordEntity = WordEntity(
    entry = entry,
    meanings = meanings.map { it.toEntity() },
)

private fun MeaningModel.toEntity(): MeaningEntity = MeaningEntity(
    wordClass = wordClass,
    description = description,
)
