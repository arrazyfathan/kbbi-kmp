...
internal fun Exception.toDataError(): DataError {
    ...
    return when {
        className.contains("Timeout") -> DataError.RequestTimeout
        className.contains("Connect") || className.contains("Host") || className.contains("Unresolved") -> DataError.NoInternet
